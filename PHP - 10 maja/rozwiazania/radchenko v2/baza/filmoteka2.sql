...
--
-- Host: 127.0.0.1
-- Czas generowania: 10 Maj 2023, 12:14
...
INSERT INTO `filmy` (`IDFilm`, `Tytul`, `Gatunek`, `IDRezysera`) VALUES
(1, 'Ojciec chrzestny ', 'dramat', 4),
(2, 'Pół żartem, pół serio', 'komedia', 3),
(3, 'Forrest Gump', 'komedia', 2),
(4, 'Cry macho', 'sensacja', 1),
(5, 'Przemytnik', 'sensacja', 1),
(6, 'Pulp Fiction', 'gangsterski', 5);
...
--
ALTER TABLE `recenzje`
  MODIFY `IDRecenzji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
